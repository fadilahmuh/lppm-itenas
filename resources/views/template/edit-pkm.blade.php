    ...
    <div class="intro-y col-span-12 lg:col-span-8">
        <div class="box p-5" id="input">
            <div>
                ...
                <input name="judul_pkm" type="text" class="input w-full border mt-2" placeholder="--Judul PKM--" value="{{$pkm->judul}}">
            </div>
            <div class="mt-3">
            ...
            <div class="mt-3">
                <label>Mitra</label>
                <input name="nama_mitra" type="text" class="input w-full border mt-2" placeholder="--Nama Mitra (Opsional)--" value="{{$pkm->nama_mitra}}">
            </div>
                ...
                <div class="grid grid-cols-12 gap-2">
                    <div class="col-span-4">
                        ...
                        <div class="relative mt-2">
                            ...
                            <input name="mulai" type="text" class="input ts-datepicker pl-12 w-full border col-span-4" placeholder="Pilih Tanggal" autocomplete="off" value="{{ \Carbon\Carbon::parse($pkm->mulai)->format('d/m/Y') }}">
                        </div>
                    </div>
                    <div class="col-span-4">
                        ...
                        <div class="relative mt-2">
                            <div class="absolute rounded-l w-10 h-full flex items-center justify-center bg-gray-100 border text-gray-600"><i class="fa-solid fa-calendar"></i></div>
                            <input name="selesai" type="text" class="input ts-datepicker pl-12 w-full border col-span-4" placeholder="Pilih Tanggal" autocomplete="off" value="{{ \Carbon\Carbon::parse($pkm->selesai)->format('d/m/Y') }}">
                        </div>
                    </div>
                    <div class="col-span-4">
                        ...
                        <div class="relative mt-2">
                            ...
                            <input name="tahun" type="text" class="bs-yearpicker input pl-12 w-full border col-span-4" value="{{$pkm->tahun}}" placeholder="--Pilih Tahun--" autocomplete="off">
                        </div>
                    </div>
                </div>
            </div>
            <div class="mt-3">
                ...
                <div class="relative mt-2">
                    ...
                    <input name="jumlah" type="text" class="input rupiah pl-12 w-full border col-span-4" placeholder="--Jumlah Dana Hibah--" autocomplete="off" value="{{$pkm->jumlah}}">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="mt-4">
                ...
                <div class="flex flex-col sm:flex-row mt-2 status-group">
                    <div class="flex items-center text-gray-700 mr-4">
                        <input type="radio" class="input border mr-2" name="status" value="1" @auth('dosen') disabled @endauth @if($pkm->status == 1) checked @endif>
                        <label class="cursor-pointer select-none" for="status-posted">Posted</label>
                    </div>
                    <div class="flex items-center text-gray-700 mr-2">
                        <input type="radio" class="input border mr-2" name="status" value="0" @if($pkm->status == 0) checked @elseif(Auth::guard('dosen')->check()) checked @endif >
